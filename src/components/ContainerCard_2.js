...
const ContainerCard_2 = () => {
  return (
    <div
      className='max-sm:m-auto m-auto max-sm:flex max-sm:flex-col max-sm:w-full'
      id='main'>
      {/* top container */}
      <div
        className='max-sm:m-auto max-sm:flex max-sm:flex-col max-sm:w-full max-sm:justify-center max-sm:items-center m-auto'
        id='Top'
        style={{
          alignSelf: "stretch",
        ...
        <div
          id='Barchart'
          class='w-full sm:w-80 p-5 bg-white rounded-lg flex flex-col items-center space-y-5'
          style={{
            width: 321,
            alignSelf: "stretch",
            paddingLeft: 20,
          ...
          <div
            className='w-full sm:w-80 p-5 rounded-lg flex flex-col items-center space-y-5'
            style={{
              flex: "1 1 0",
              height: 291,
      ...
      {/* down container */}
      <div className='max-sm:flex max-sm:flex-col w-full'>
